...
<div class="panel panel-info">
        <div class="panel-heading">
            <h4>
                ...
                <span class="pull-right">
                    <?= Html::a('Kembali', ['/site/index'], ['class' => 'btn btn-danger btn-sm']) ?>
                </span>
            </h4>
        </div>
 ...
 <?php $form = ActiveForm::begin(); ?>
                <div class="col-sm-6">
                <?php echo $form->field($model, 'mhs_bp')->textInput(['readOnly' => true,]) ?>
                <?php echo $form->field($model, 'mhs_nama')->textInput(['readOnly' => true]) ?>
            ...
            <div class="form-group" align="center" style="box-sizing: border-box;">
             <?= Html::a('Batal', ['mahasiswa/view'], ['class' => 'fa fa-ban btn btn-default']) ?>
