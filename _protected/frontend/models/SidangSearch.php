...
/**
 * SidangSearch represents the model behind the search form about `frontend\models\Sidang`.
 */
class SidangSearch extends Sidang
{
    ...
    {
        return [
            [['s_id', 's_bp', 's_pembimbing', 's_penguji', 's_tempat_pkl'], 'integer'],
            [['s_tgl_sidang', 's_ruang', 's_jam','s_jam2'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 's_ruang', $this->s_ruang])
