...
<div class="laporan-search">
    ...
    $arrData = urlencode(serialize(['tahun' => $model->tahun]));
    echo Form::widget([
        'model' => $model,
        'form' => $form,
        'columns' => 2,
        'attributes' => [
            'actions' => [
                ...
                'value' => '<div style="text-align: left; margin-top: 0px">' .
            		...
            		((!empty($data)) ? Html::a('Cetak', ['print', 'arrdata'=>$arrData,'act'=>'cetak-pembimbing'], ['class' => 'fa fa-print btn btn-success', 'style' => 'margin-left:10px;', 'target' => '_blank']) : '') .
            		'</div>'
            ],
        ]
    ]);
